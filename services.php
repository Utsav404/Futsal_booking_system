...
<h2>SERVICES</h2>
<p>The Baneshwor Futsal Ground is popular because of their best services provided to their members and bookers. 
    <br>Following are the major services:<br> </span>
 </p>
<button class="down">1.SWIMMING POOL</button>
    <div class="panel panel-primary"><p class="text-info">The Baneshwor Swimming Pool is providing extra recreational and refreshing services where people can enjoy before/after the match.</p>
    ...
    <div class="modal-dialog">
      ...
      <div style=" background-image: url(img/backgr.jpg);" class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Baneshwor Futsal Store</h4>
        </div>
