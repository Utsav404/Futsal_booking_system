...
  </a>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header" align="center" style="background-color:#213e4a; color: #d9d9d9; position: relative;top: 2px; padding:20px; center; border-radius: 12px; border-color: #444; box-shadow: 2px 4px 5px #888;">
                    Welcome to Baneshwor Futsal</h3>
            </div>
            <div class="col-md-4" >
                <div class="panel panel-default" style="background-color:#ffc0cb; color: #333; height: 250px;">
                    <div class="panel-body" style="">
                        <p align="justify">Baneshwor Futsal is one of the fastest-growing futsal co. in Nepal and has been selected as the number one futsal for training and development by many players.This futsal recognizes that futsal is a stand-alone sport and an exciting game for players at all levels, but futsal is also an essential component of soccer development.</p>
